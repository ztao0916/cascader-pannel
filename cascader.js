...
(function () {
  ...
  var eo_cascader = (function () {
      ...
      for (let i = 0; i < menus.length; i++) {
        ...
        for (let k = 0; k < menusList.length; k++) {
          ...
          if (_this.multiple) {
            ...
            checkbox.addEventListener('click', _this.bindClickEvent.bind(checkbox, _this, _this.handleCheckCb));
    ...
    EoCascader.prototype.handleCheckCb = function handleCheckCb(currentMenu, _this, isChecked) {
      ...
      // 存储当前选中状态
      currentMenu[0].children.length ? _this.showReviewCheckedOb(currentMenu[0]) : _this.handleReviewCheckedOb(currentMenu[0]);
